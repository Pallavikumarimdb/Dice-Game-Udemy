...
if (randomNumber1 === randomNumber2) {
  var a = document.getElementsByTagName("h1")[0].innerHTML = "ITS A TIE";
} else if (randomNumber1 > randomNumber2) {
  var a = document.getElementsByTagName("h1")[0].innerHTML = "PLAYER 1 WINS Woo-Hoo";

} else {
  var a = document.getElementsByTagName("h1")[0].innerHTML = "PLAYER 2 WINS Woo-Hoo";
}
